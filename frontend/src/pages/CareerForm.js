...
//         let chatId = activeChatId;
//         if (!chatId) {
//           const res = await createChat(resumeText.slice(0, 30) + "...");
//           chatId = res.data.id;
//           setActiveChatId(chatId);
//           await fetchChats();
//         }
...
//       {/* Sidebar */}
//       <div
//         className="bg-dark text-white p-3 offcanvas-md offcanvas-start"
//         tabIndex="-1"
//         id="sidebarMenu"
//         style={{ width: 280 }}
//       >
//         <div className="mb-3 fw-bold fs-5">Career Path Analyzer</div>

//         <button
//           className="btn btn-outline-light mb-3 d-flex align-items-center gap-2 w-100"
//           onClick={handleNewChat}
//         >
//           <i className="bi bi-plus-lg"></i> New Chat
//         </button>
...
//             <Link to="/register" className="btn btn-light shadow-sm">
//               <span className="material-symbols-outlined">person</span> Register
//             </Link>
...
//                 >
//                   {!parsed && msg.text && <p className="mb-2">{msg.text}</p>}
//                   {/* keep your parsed rendering logic here */}
//                 </div>
//               </div>
//             );
//           })}

//           {loading && <p className="text-center fst-italic">⏳ Analyzing your resume...</p>}
//           <div ref={chatEndRef} />
//         </div>

//         {/* Input */}
//         <form
//           className="d-flex flex-column flex-sm-row p-3 border-top bg-white gap-2"
//           onSubmit={handleSubmit}
//         >
//           <textarea
//             className="form-control rounded-3 shadow-sm flex-grow-1"
//             rows="2"
//             placeholder="Paste your resume text or skills here..."
//             value={resumeText}
//             onChange={(e) => setResumeText(e.target.value)}
